{
  ...
  in
    if (attr == "flit-core" || attr == "flit" || attr == "hatchling") && !self.isPy3k
    then drv
    else if drv == null
    then null
  ...
  lib.composeManyExtensions [
    ...
    (
      ...
      in {
        ...
        argon2-cffi =
          if (lib.versionAtLeast super.argon2-cffi.version "21.2.0")
          then
            addBuildSystem'
            {
              inherit self;
        ...
        granian = super.granian.overridePythonAttrs (old:
          lib.optionalAttrs (!(old.src.isWheel or false))
          (
            let
              githubHash =
          ...
          then
            ...
            (old: {
              ...
              postPatch =
                old.postPatch
                or ""
                + lib.optionalString (!(old.src.isWheel or false) && (lib.versionAtLeast super.jsonschema.version "4.18.0")) ''
        ...
        notebook =
          if (lib.versionAtLeast super.notebook.version "7.0.0")
          then
        ...
        orjson = super.orjson.overridePythonAttrs (old:
          if old.src.isWheel or false
          then {}
          else
            (
              let
        ...
        jsii = super.jsii.overridePythonAttrs (old:
          lib.optionalAttrs (!(old.src.isWheel or false)) {
            postPatch = ''
              substituteInPlace pyproject.toml \
