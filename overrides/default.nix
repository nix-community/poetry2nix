...
lib.composeManyExtensions [
  ...
  (
    ...
    let
      ...
      bootstrappingBase =
        (pkgs.${final.python.pythonAttr}.pythonOnBuildForHost
          or pkgs.${final.python.pythonAttr}.pythonForBuild
        ).pkgs;
...

    {
      ...
      aiohttp-swagger3 = prev.aiohttp-swagger3.overridePythonAttrs (old: {
        nativeBuildInputs = old.nativeBuildInputs or [ ] ++ [ final.pytest-runner ];
      });

      ansible = prev.ansible.overridePythonAttrs (old: {
      ...
      ansible-lint = prev.ansible-lint.overridePythonAttrs (old: {
      ...
      argcomplete = prev.argcomplete.overridePythonAttrs (old: {
      ...
      astroid = prev.astroid.overridePythonAttrs (old: {
      ...
      bjoern = prev.bjoern.overridePythonAttrs (old: {
      ...
      cairosvg = prev.cairosvg.overridePythonAttrs (old: {
        buildInputs = old.buildInputs or [ ] ++ [ final.pytest-runner ];
      });
      ...
      cssselect2 = prev.cssselect2.overridePythonAttrs (old: {
        buildInputs = old.buildInputs or [ ] ++ [ final.pytest-runner ];
      });

      cffi =
        # cffi is bundled with pypy
        if final.python.implementation == "pypy" then
          null
        else
          (prev.cffi.overridePythonAttrs (old: {
            nativeBuildInputs = old.nativeBuildInputs or [ ] ++ [ pkg-config ];
      ...
      clarabel = prev.dbt-extractor.overridePythonAttrs (old: {
      ...
      coincurve = prev.coincurve.overridePythonAttrs (_old: {
        # package setup logic
      ...
      configparser = prev.configparser.overridePythonAttrs (old: {
        buildInputs = old.buildInputs or [ ] ++ [
          final.toml
        ];
      });

      confluent-kafka = prev.confluent-kafka.overridePythonAttrs (old: {
        buildInputs = old.buildInputs or [ ] ++ [
          pkgs.rdkafka
        ];
      });
        ...
        scrypto.overridePythonAttrs (
          old:
          {
            nativeBuildInputs =
              ...
              ++ lib.optionals (lib.versionAtLeast old.version "3.5" && !isWheel) [
                pkgs.rustPlatform.cargoSetupHook
                pkgs.cargo
                pkgs.rustc
              ]
              ++ lib.optionals (lib.versionAtLeast old.version "43" && !isWheel) [
      ...
      dask = prev.dask.overridePythonAttrs (old: {
        propagatedBuildInputs = removePackagesByName old.propagatedBuildInputs or [ ] (
      ...
      dbt-extractor = prev.dbt-extractor.overridePythonAttrs (old: {
        nativeBuildInputs = old.nativeBuildInputs or [ ] ++ [
          pkgs.cargo
          pkgs.rustc
          pkgs.maturin
      ...
      dbus-python = prev.dbus-python.overridePythonAttrs (
        old:
        {
          outputs = [
            "out"
      ...
      dictdiffer = prev.dictdiffer.overridePythonAttrs (old: {
        buildInputs = old.buildInputs or [ ] ++ [ final.pytest-runner ];
        propagatedBuildInputs = old.propagatedBuildInputs or [ ] ++ [ final.setuptools ];
      });
      ...
      django-bakery = prev.django-bakery.overridePythonAttrs (old: {
        configurePhase =
          ''
      ...
      django-cors-headers = prev.django-cors-headers.overridePythonAttrs (old: {
        nativeBuildInputs = old.nativeBuildInputs or [ ] ++ [ final.pytest-runner ];
      });

      django-hijack = prev.django-hijack.overridePythonAttrs (old: {
        nativeBuildInputs = old.nativeBuildInputs or [ ] ++ [ final.pytest-runner ];
      });

      django-prometheus = prev.django-prometheus.overridePythonAttrs (old: {
        nativeBuildInputs = old.nativeBuildInputs or [ ] ++ [ final.pytest-runner ];
      });

      django-rosetta = prev.django-rosetta.overridePythonAttrs (old: {
        nativeBuildInputs = old.nativeBuildInputs or [ ] ++ [ final.pytest-runner ];
      });

      django-stubs-ext = prev.django-stubs-ext.overridePythonAttrs (old: {
        prePatch = (old.prePatch or "") + "touch ../LICENSE.txt";
      });

      dlib = prev.dlib.overridePythonAttrs (old: {
      ...
      docutils = prev.docutils.overridePythonAttrs (
        _:
        lib.optionalAttrs
          (lib.versionOlder prev.docutils.version "0.16" && lib.versionAtLeast prev.setuptools.version "60")
          {
      ...
      faker = prev.faker.overridePythonAttrs (old: {
        buildInputs = old.buildInputs or [ ] ++ [ final.pytest-runner ];
        doCheck = false;
      });
      ...
      fastparquet = prev.fastparquet.overridePythonAttrs (old: {
        buildInputs = old.buildInputs or [ ] ++ [ final.pytest-runner ];
      });
      ...
      fiona = prev.fiona.overridePythonAttrs (old: {
      ...
      gdal = prev.gdal.overridePythonAttrs (old: {
        nativeBuildInputs = old.nativeBuildInputs or [ ] ++ [
          gdal
          final.numpy
        ];
      ...
      gmsh = prev.gmsh.overridePythonAttrs (old: {
        buildInputs = old.buildInputs or [ ] ++ [
          pkgs.libGLU
      ...
      gnureadline = prev.gnureadline.overridePythonAttrs (old: {
        buildInputs = old.buildInputs or [ ] ++ [ pkgs.ncurses ];
      });

      google-re2 = prev.google-re2.overridePythonAttrs (old: {
        buildInputs = old.buildInputs or [ ] ++ [
          pkgs.abseil-cpp
          final.pybind11
          pkgs.re2
      ...
      grandalf = prev.grandalf.overridePythonAttrs (old: {
        buildInputs = old.buildInputs or [ ] ++ [ final.pytest-runner ];
        doCheck = false;
      });

      granian = prev.granian.overridePythonAttrs (
        old:
        lib.optionalAttrs (!(old.src.isWheel or false)) (
          let
            githubHash =
      ...
      gitpython = prev.gitpython.overridePythonAttrs (old: {
      ...
      h3 = prev.h3.overridePythonAttrs (old: {
        preBuild =
          (old.preBuild or "")
          + ''
      ...
      hid = prev.hid.overridePythonAttrs (_old: {
        postPatch = ''
          found=
      ...
      hidapi = prev.hidapi.overridePythonAttrs (old: {
      ...
      hikari-lightbulb = prev.hikari-lightbulb.overrideAttrs (old: {
        buildInputs = old.buildInputs or [ ] ++ [ final.setuptools ];
      });

      horovod = prev.horovod.overridePythonAttrs (old: {
      ...
      igraph = prev.igraph.overridePythonAttrs (old: {
        nativeBuildInputs = [ cmake ] ++ old.nativeBuildInputs or [ ];
        dontUseCmakeConfigure = true;
      });

      imagecodecs = prev.imagecodecs.overridePythonAttrs (old: {
        patchPhase = ''
          substituteInPlace setup.py \
      ...
      importlib-metadata = prev.importlib-metadata.overridePythonAttrs (old: {
        propagatedBuildInputs =
          old.propagatedBuildInputs or [ ]
          ++ lib.optionals final.python.isPy2 [ final.pathlib2 ];
      });

      intreehooks = prev.intreehooks.overridePythonAttrs (_old: {
        doCheck = false;
      });
      ...
      isort = prev.isort.overridePythonAttrs (old: {
        propagatedBuildInputs = old.propagatedBuildInputs or [ ] ++ [ final.setuptools ];
      });

      jaraco-functools = prev.jaraco-functools.overridePythonAttrs (old: {
      ...
      jinja2-ansible-filters = prev.jinja2-ansible-filters.overridePythonAttrs (old: {
        preBuild =
          (old.preBuild or "")
          + ''
      ...
      jira = prev.jira.overridePythonAttrs (old: {
      ...
      jsonschema = prev.jsonschema.overridePythonAttrs (
        ...
        lib.optionalAttrs (lib.versionAtLeast old.version "4.0.0") {
          ...
          postPatch =
            old.postPatch or ""
            + lib.optionalString (!(old.src.isWheel or false) && lib.versionAtLeast old.version "4.18.0") ''
      ...
      jupyter = prev.jupyter.overridePythonAttrs (_old: {
      ...
      jupyterlab-widgets = prev.jupyterlab-widgets.overridePythonAttrs (old: {
      ...
      kiwisolver = prev.kiwisolver.overridePythonAttrs (old: {
        buildInputs = old.buildInputs or [ ] ++ [
          final.cppy
        ];
      });

      lap = prev.lap.overridePythonAttrs (old: {
        propagatedBuildInputs = old.propagatedBuildInputs or [ ] ++ [
          final.numpy
        ];
      });
      ...
      lightgbm = prev.lightgbm.overridePythonAttrs (old: {
        nativeBuildInputs = [ cmake ] ++ old.nativeBuildInputs or [ ];
        dontUseCmakeConfigure = true;
        postConfigure = ''
          export HOME=$(mktemp -d)
      ...
      m2crypto = prev.m2crypto.overridePythonAttrs (old: {
        nativeBuildInputs = old.nativeBuildInputs or [ ] ++ [ swig ];
        buildInputs = old.buildInputs or [ ] ++ [ pkgs.openssl ];
      });

      mariadb = prev.mariadb.overridePythonAttrs (old: {
        nativeBuildInputs = old.nativeBuildInputs or [ ] ++ [
          pkg-config
          pkgs.libmysqlclient
        ];
      ...
      markdown-it-py = prev.markdown-it-py.overridePythonAttrs (old: {
      ...
      markupsafe = prev.markupsafe.overridePythonAttrs (old: {
      ...
      mccabe = prev.mccabe.overridePythonAttrs (old: {
        buildInputs = old.buildInputs or [ ] ++ [ final.pytest-runner ];
        doCheck = false;
      });

      mip = prev.mip.overridePythonAttrs (old: {
      ...
      mmdet = prev.mmdet.overridePythonAttrs (old: {
      ...
      munch = prev.munch.overridePythonAttrs (old: {
      ...
      multiaddr = prev.multiaddr.overridePythonAttrs (old: {
        buildInputs = old.buildInputs or [ ] ++ [ final.pytest-runner ];
      });
      ...
      mysqlclient = prev.mysqlclient.overridePythonAttrs (old: {
        nativeBuildInputs = old.nativeBuildInputs or [ ] ++ [
          pkg-config
          pkgs.libmysqlclient
        ];
      ...
      netcdf4 = prev.netcdf4.overridePythonAttrs (old: {
        propagatedBuildInputs = old.propagatedBuildInputs or [ ] ++ [
          pkgs.zlib
          pkgs.netcdf
          pkgs.hdf5
        ...
        in
        {
          ...
          format =
            if ((old.format or null) == "poetry2nix") then
              (if lib.versionAtLeast prev.numpy.version "2.0.0" then "pyproject" else "setuptools")
            else
              old.format or null;
      ...
      open3d = prev.open3d.overridePythonAttrs (old: {
        ...
        preFixup =
          lib.optionalString (stdenv.isDarwin && lib.versionAtLeast prev.open3d.version "0.16.0")
            ''
      ...
      openexr = prev.openexr.overridePythonAttrs (old: {
        buildInputs = old.buildInputs or [ ] ++ [
          pkgs.openexr
          pkgs.ilmbase
        ];
      ...
      openvino = prev.openvino.overridePythonAttrs (old: {
        buildInputs = [
          pkgs.ocl-icd
          pkgs.hwloc
          pkgs.tbb
      ...
      osqp = prev.osqp.overridePythonAttrs (old: {
        nativeBuildInputs = old.nativeBuildInputs or [ ] ++ [ cmake ];
        dontUseCmakeConfigure = true;
      });
      ...
      parsel = prev.parsel.overridePythonAttrs (old: {
        nativeBuildInputs = old.nativeBuildInputs or [ ] ++ [ final.pytest-runner ];
      });

      pdal = prev.pdal.overridePythonAttrs (_old: {
      ...
      pikepdf = prev.pikepdf.overridePythonAttrs (old: {
        buildInputs = old.buildInputs or [ ] ++ [
          pkgs.qpdf
          final.pybind11
        ];
      ...
      pillow-heif = prev.pillow-heif.overridePythonAttrs (old: {
        nativeBuildInputs = old.nativeBuildInputs or [ ] ++ [ pkg-config ];
      ...
      polling2 = prev.polling2.overridePythonAttrs (old: {
        nativeBuildInputs = old.nativeBuildInputs or [ ] ++ [ final.pytest-runner ];
      });

      portend = prev.portend.overridePythonAttrs (old: {
        # required for the extra "toml" dependency in setuptools_scm[toml]
        buildInputs = old.buildInputs or [ ] ++ [
          final.toml
        ];
      ...
      psycopg2cffi = prev.psycopg2cffi.overridePythonAttrs (old: {
        buildInputs = old.buildInputs or [ ] ++ lib.optionals stdenv.isDarwin [ pkgs.openssl ];
        nativeBuildInputs = old.nativeBuildInputs or [ ] ++ [ pkgs.postgresql ];
      });
      ...
      pycurl = prev.pycurl.overridePythonAttrs (old: {
      ...
      py-solc-x = prev.py-solc-x.overridePythonAttrs (old: {
        preConfigure = ''
          substituteInPlace setup.py --replace-warn \'setuptools-markdown\' ""
        '';
        propagatedBuildInputs = old.propagatedBuildInputs or [ ] ++ [
      ...
      pycocotools = prev.pycocotools.overridePythonAttrs (old: {
        buildInputs = old.buildInputs or [ ] ++ [
          final.numpy
        ];
      });
      ...
      pygame = prev.pygame.overridePythonAttrs (_old: rec {
        nativeBuildInputs = [
          pkg-config
          pkgs.SDL
        ];
      ...
      pygeos = prev.pygeos.overridePythonAttrs (old: {
      ...
      pylint = prev.pylint.overridePythonAttrs (old: {
        buildInputs = old.buildInputs or [ ] ++ [ final.pytest-runner ];
      });
      ...
      pyopencl = prev.pyopencl.overridePythonAttrs (old: {
      ...
      pyproj = prev.pyproj.overridePythonAttrs (_old: {
        PROJ_DIR = "${pkgs.proj}";
      ...
      pytesseract =
        ...
        prev.pytesseract.overridePythonAttrs (old: {
          ...
          patches =
            (old.patches or [ ])
            ++ lib.optionals (!(old.src.isWheel or false)) [ pytesseract-cmd-patch ];
      ...
      python-bugzilla = prev.python-bugzilla.overridePythonAttrs (old: {
        nativeBuildInputs = old.nativeBuildInputs or [ ] ++ [ final.docutils ];
      });

      python-ldap = prev.python-ldap.overridePythonAttrs (old: {
        buildInputs = old.buildInputs or [ ] ++ [
          pkgs.openldap
          pkgs.cyrus_sasl
      ...
      pytoml = prev.pytoml.overridePythonAttrs (_old: {
        doCheck = false;
      });
      ...
      pyqt5 =
        ...
        in
        prev.pyqt5.overridePythonAttrs (old: {
          postPatch = ''
            # Confirm license
      ...
      pyqt5-qt5 =
        ...
        in
        prev.pyqt5-qt5.overridePythonAttrs (old: {
          dontWrapQtApps = true;
          propagatedBuildInputs =
            old.propagatedBuildInputs or [ ]
            ++ pyQt5Modules qt5
      ...
      pyqt6 =
        let
          pyqt6 = prev.pyqt6.overridePythonAttrs (
            old:
            let
      ...
      pytest-datadir = prev.pytest-datadir.overridePythonAttrs (_old: {
        postInstall = ''
          rm -f $out/LICENSE
        '';
      });
      ...
      pytest-django = prev.pytest-django.overridePythonAttrs (_old: {
        postPatch = ''
          # sometimes setup.py doesn't exist
          if [ -f setup.py ]; then
      ...
      pytest-pylint = prev.pytest-pylint.overridePythonAttrs (_old: {
      ...
      python-jose = prev.python-jose.overridePythonAttrs (_old: {
        buildInputs = [ final.pytest-runner ];
      });
      ...
      python-olm = prev.python-olm.overridePythonAttrs (old: {
        buildInputs = old.buildInputs or [ ] ++ [ pkgs.olm ];
      });

      python-pam = prev.python-pam.overridePythonAttrs (_old: {
        postPatch = ''
      ...
      python-snappy = prev.python-snappy.overridePythonAttrs (old: {
      ...
      ffmpeg-python = prev.ffmpeg-python.overridePythonAttrs (old: {
        buildInputs = old.buildInputs or [ ] ++ [ final.pytest-runner ];
      });

      python-prctl = prev.python-prctl.overridePythonAttrs (old: {
        buildInputs = old.buildInputs or [ ] ++ [
          pkgs.libcap
        ];
      });
      ...
      pyusb = prev.pyusb.overridePythonAttrs (_old: {
        postPatch = ''
      ...
      pywavelets = prev.pywavelets.overridePythonAttrs (old: {
        HDF5_DIR = "${pkgs.hdf5}";
      ...
      recommonmark = prev.recommonmark.overridePythonAttrs (old: {
      ...
      referencing = prev.referencing.overridePythonAttrs (
        old:
        lib.optionalAttrs (!(old.src.isWheel or false)) {
          postPatch =
            old.postPatch or ""
      ...
      rpds-py =
        let
          getCargoHash =
            ...
            .${version}
              or (lib.warn "Unknown rpds-py version: '${version}'. Please update getCargoHash." lib.fakeHash);
        in
        prev.rpds-py.overridePythonAttrs (
          old:
          lib.optionalAttrs (!(old.src.isWheel or false)) {
            cargoDeps = pkgs.rustPlatform.fetchCargoTarball {
              inherit (old) src;
      ...
      ruamel-yaml = prev.ruamel-yaml.overridePythonAttrs (old: {
        propagatedBuildInputs = old.propagatedBuildInputs or [ ] ++ [ final.ruamel-yaml-clib ];
      });
      ...
      ruff =
        let
          ...
          getRepoHash =
            ...
            .${version}
              or (lib.warn "Unknown ruff version: '${version}'. Please update getRepoHash." lib.fakeHash);
          ...
          getCargoHash =
            ...
            .${version} or (lib.warn "Unknown ruff version: '${version}'. Please update getCargoHash." null);
        ...
        prev.ruff.overridePythonAttrs (
          ...
          let
            ...
            cargoDeps =
              let
                hash = getCargoHash prev.ruff.version;
              in
      ...
      scipy = prev.scipy.overridePythonAttrs (
        ...
        lib.optionalAttrs (!(old.src.isWheel or false)) {
          nativeBuildInputs =
            ...
            ++ lib.optionals (lib.versionAtLeast prev.scipy.version "1.9.0") [
              final.meson-python
              pkg-config
            ];
          dontUseMesonConfigure = true;
          ...
          prePatch =
            (old.prePatch or "")
            + lib.optionalString (stdenv.isDarwin && (lib.versionAtLeast old.version "1.14.0")) ''
      ...
      scikit-build-core = prev.scikit-build-core.overridePythonAttrs (old: {
        propagatedBuildInputs = old.propagatedBuildInputs or [ ] ++ [
      ...
      scikit-image = prev.scikit-image.overridePythonAttrs (old: {
        nativeBuildInputs = old.nativeBuildInputs or [ ] ++ [
          final.pythran
          final.packaging
          final.wheel
      ...
      shapely = prev.shapely.overridePythonAttrs (old: {
        ...
        GEOS_LIBC = lib.optionalString (
          !stdenv.isDarwin
        ) "${lib.getLib stdenv.cc.libc}/lib/libc${sharedLibExt}.6";
      ...
      jsii = prev.jsii.overridePythonAttrs (
        old:
        lib.optionalAttrs (!(old.src.isWheel or false)) {
          postPatch = ''
            substituteInPlace pyproject.toml \
      ...
      tables = prev.tables.overridePythonAttrs (old: {
      ...
      tempora = prev.tempora.overridePythonAttrs (old: {
        # required for the extra "toml" dependency in setuptools_scm[toml]
        buildInputs = old.buildInputs or [ ] ++ [
          final.toml
        ];
      ...
      tensorboard = prev.tensorboard.overridePythonAttrs (old: {
        buildInputs = old.buildInputs or [ ] ++ [
          final.wheel
          final.absl-py
        ];
      ...
      tensorflow-io-gcs-filesystem = prev.tensorflow-io-gcs-filesystem.overridePythonAttrs (old: {
        buildInputs = old.buildInputs or [ ] ++ [
          pkgs.libtensorflow
        ];
      });

      tensorflow = prev.tensorflow.overridePythonAttrs (_old: tensorflowAttrs);
      ...
      tensorpack = prev.tensorpack.overridePythonAttrs (_old: {
        postPatch = ''
      ...
      urwidtrees = prev.urwidtrees.overridePythonAttrs (old: {
        propagatedBuildInputs = old.propagatedBuildInputs or [ ] ++ [
          final.urwid
        ];
      });

      vose-alias-method = prev.vose-alias-method.overridePythonAttrs (_old: {
        postInstall = ''
          rm -f $out/LICENSE
        '';
      });

      vispy = prev.vispy.overrideAttrs (_: {
      ...
      watchfiles =
        let
          ...
          getCargoHash =
            ...
            .${version}
              or (lib.warn "Unknown watchfiles version: '${version}'. Please update getCargoHash." null);
        in
        prev.watchfiles.overridePythonAttrs (
          old:
          let
            src = pkgs.fetchFromGitHub {
              owner = "samuelcolvin";
            ...
            cargoDeps =
              ...
              if hash == null || lib.isAttrs hash then
                pkgs.rustPlatform.importCargoLock (
                  ...
                  // (lib.optionalAttrs (lib.isAttrs hash) hash)
                )
              else
                pkgs.rustPlatform.fetchCargoTarball {
      ...
      weblate-language-data = prev.weblate-language-data.overridePythonAttrs (old: {
        buildInputs = old.buildInputs or [ ] ++ [
      ...
      zipp =
        if prev.zipp == null then
          null
        else
          prev.zipp.overridePythonAttrs (old: {
            propagatedBuildInputs = old.propagatedBuildInputs or [ ] ++ [
              final.toml
            ];
          });
      ...
      supervisor = prev.supervisor.overridePythonAttrs (old: {
        propagatedBuildInputs = old.propagatedBuildInputs or [ ] ++ [
          final.meld3
          final.setuptools
        ];
      ...
      cytoolz = prev.cytoolz.overridePythonAttrs (old: {
      ...
      tqdm = prev.tqdm.overridePythonAttrs (old: {
      ...
      pyee = prev.pyee.overrideAttrs (old: {
        postPatch =
          old.postPatch or ""
      ...
      newrelic = prev.newrelic.overridePythonAttrs (old: {
        postPatch =
          old.postPatch or ""
          + ''
      ...
      wxpython = prev.wxpython.overridePythonAttrs (
        old:
        let
      ...
      marisa-trie = prev.marisa-trie.overridePythonAttrs (old: {
        buildInputs = old.buildInputs or [ ] ++ [ final.pytest-runner ];
      });

      ua-parser = prev.ua-parser.overridePythonAttrs (old: {
        propagatedBuildInputs = old.propagatedBuildInputs or [ ] ++ [ final.pyyaml ];
      });
      ...
      wcwidth = prev.wcwidth.overridePythonAttrs (old: {
        propagatedBuildInputs =
          old.propagatedBuildInputs or [ ]
          ++ lib.optionals final.isPy27 [
            (final.backports-functools-lru-cache or final.backports_functools_lru_cache)
          ];
      });
      ...
      flake8-mutable = prev.flake8-mutable.overridePythonAttrs (old: {
        buildInputs = old.buildInputs or [ ] ++ [ final.pytest-runner ];
      });
      ...
      vllm = prev.vllm.overridePythonAttrs (
        old:
        {
          ...
          propagatedBuildInputs = removePackagesByName (old.propagatedBuildInputs or [ ]) (
            lib.optionals (final ? vllm-nccl-cu12) [ final.vllm-nccl-cu12 ]
          );
