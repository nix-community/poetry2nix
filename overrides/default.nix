...
lib.composeManyExtensions [
  ...
  (
    ...
    let
      ...
      bootstrappingBase =
        (pkgs.${self.python.pythonAttr}.pythonOnBuildForHost
          or pkgs.${self.python.pythonAttr}.pythonForBuild
        ).pkgs;
    in

    {
      ...
      clarabel = super.dbt-extractor.overridePythonAttrs (old: {
        nativeBuildInputs = (old.nativeBuildInputs or [ ]) ++ [
          pkgs.cargo
          pkgs.rustc
          pkgs.maturin
      ...
      coincurve = super.coincurve.overridePythonAttrs (_old: {
        # package setup logic
      ...
      docutils =
        ...
        then
          (super.docutils.overridePythonAttrs (_old: {
      ...
      file-magic = super.file-magic.overridePythonAttrs (_old: {
        postPatch = ''
      ...
      gnureadline = super.gnureadline.overridePythonAttrs (old: {
        buildInputs = (old.buildInputs or [ ]) ++ [ pkgs.ncurses ];
      });

      granian = super.granian.overridePythonAttrs (
        old:
        lib.optionalAttrs (!(old.src.isWheel or false)) (
          let
            githubHash =
      ...
      hid = super.hid.overridePythonAttrs (_old: {
        postPatch = ''
          found=
      ...
      hidapi = super.hidapi.overridePythonAttrs (old: {
        propagatedBuildInputs = old.propagatedBuildInputs or [ ] ++ [
          pkgs.libusb1
        ];
      ...
      intreehooks = super.intreehooks.overridePythonAttrs (_old: {
        doCheck = false;
      });
      ...
      jsondiff =
        if lib.versionOlder super.jsondiff.version "2.0.0" then
          super.jsondiff.overridePythonAttrs (old: {
        ...
        if lib.versionAtLeast super.jsonschema.version "4.0.0" then
          super.jsonschema.overridePythonAttrs (old: {
            ...
            postPatch =
              ...
              +
                lib.optionalString
                  (!(old.src.isWheel or false) && (lib.versionAtLeast super.jsonschema.version "4.18.0"))
                  ''
      ...
      jsonschema-specifications = super.jsonschema-specifications.overridePythonAttrs (
        old:
        lib.optionalAttrs (!(old.src.isWheel or false)) {
          postPatch =
            old.postPatch or ""
      ...
      jupyter = super.jupyter.overridePythonAttrs (_old: {
      ...
      m2crypto = super.m2crypto.overridePythonAttrs (old: {
        nativeBuildInputs = (old.nativeBuildInputs or [ ]) ++ [ pkgs.swig ];
        buildInputs = (old.buildInputs or [ ]) ++ [ pkgs.openssl ];
      });

      markdown-it-py = super.markdown-it-py.overridePythonAttrs (old: {
      ...
      notebook =
        if (lib.versionAtLeast super.notebook.version "7.0.0") then
          super.notebook.overridePythonAttrs (old: {
            buildInputs = (old.buildInputs or [ ]) ++ [
              super.hatchling
      ...
      orjson = super.orjson.overridePythonAttrs (
        old:
      ...
      pdal = super.pdal.overridePythonAttrs (_old: {
      ...
      pillow-heif = super.pillow-heif.overridePythonAttrs (old: {
        buildInputs =
          with pkgs;
          (old.buildInputs or [ ])
          ++ [
      ...
      pycurl = super.pycurl.overridePythonAttrs (old: {
      ...
      pygame = super.pygame.overridePythonAttrs (_old: rec {
        nativeBuildInputs = [
          pkg-config
          pkgs.SDL
        ];
      ...
      pyodbc = super.pyodbc.overridePythonAttrs (
        old:
        lib.optionalAttrs ((old.src.isWheel or false) && stdenv.isLinux) {
          preFixup =
            old.preFixup or ""
            + ''
      ...
      pyproj = super.pyproj.overridePythonAttrs (_old: {
        PROJ_DIR = "${pkgs.proj}";
      ...
      pytoml = super.pytoml.overridePythonAttrs (_old: {
        doCheck = false;
      });
      ...
      pyqt6 =
        let
          ...
          pyqt6 = pyqt6-wheel.overridePythonAttrs (
            old:
            let
      ...
      pytest-datadir = super.pytest-datadir.overridePythonAttrs (_old: {
        postInstall = ''
          rm -f $out/LICENSE
        '';
      });
      ...
      pytest-django = super.pytest-django.overridePythonAttrs (_old: {
        postPatch = ''
      ...
      python-pam = super.python-pam.overridePythonAttrs (_old: {
        postPatch = ''
      ...
      pyusb = super.pyusb.overridePythonAttrs (_old: {
        postPatch = ''
      ...
      recommonmark = super.recommonmark.overridePythonAttrs (old: {
      ...
      rockset = super.rockset.overridePythonAttrs (_old: {
        postPatch = ''
          cp ./setup_rockset.py ./setup.py
        '';
      });

      scaleapi = super.scaleapi.overridePythonAttrs (_old: {
        postPatch = ''
      ...
      referencing = super.referencing.overridePythonAttrs (
        old:
        lib.optionalAttrs (!(old.src.isWheel or false)) {
          postPatch =
            old.postPatch or ""
      ...
      rpds-py =
        ...
        in
        super.rpds-py.overridePythonAttrs (
          old:
          lib.optionalAttrs (!(old.src.isWheel or false)) {
            cargoDeps = pkgs.rustPlatform.fetchCargoTarball {
              inherit (old) src;
      ...
      tensorflow = super.tensorflow.overridePythonAttrs (_old: {
        postInstall = ''
          rm $out/bin/tensorboard
        '';
      });

      tensorflow-macos = super.tensorflow-macos.overridePythonAttrs (_old: {
        inherit (self.tensorflow) postInstall;
      });

      tensorpack = super.tensorpack.overridePythonAttrs (_old: {
        postPatch = ''
      ...
      vose-alias-method = super.vose-alias-method.overridePythonAttrs (_old: {
        postInstall = ''
          rm -f $out/LICENSE
        '';
      });
        ...
        super.watchfiles.overridePythonAttrs (
          ...
          lib.optionalAttrs (!(old.src.isWheel or false)) (
            let
              ...
              cargoDeps =
                let
                  hash = getCargoHash super.watchfiles.version;
                in
                if hash == null then
                  pkgs.rustPlatform.importCargoLock {
                    lockFile = "${src.out}/Cargo.lock";
